# [Задача со звездочкой]: усложненный вариант задания 2. Доработать функцию currency_rates: теперь она должна возвращать
# курс валюты и дату, которая передаётся в ответе сервера. Название новой функции currency_rates_advanced.
#
